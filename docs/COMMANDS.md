...
```powershell
cd "C:\Users\Wouter Termaat\OneDrive - Topicus\Documenten\Privé\CoasterRanker\scripts\database\src"; python test_merger.py; cd ..\..\..\database\data; Remove-Item test_*.json; cd ..\..\..\scripts\database\src; python update_coasters_simple.py --start 1 --end 200
```
