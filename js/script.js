// Coaster data - will be loaded from the database
    ...
    // Utility function to ensure all URLs use HTTPS to prevent mixed content errors
    ...
    const processResults = (results, strategy) => {
        ...
        if (returnAll) {
            ...
            for (const result of results) {
                ...
                const normalizedUrl = forceHttps(imageUrl);
